...
function systemInfo($ipAddress) {
    ...
    $ipDetails = json_decode(file_get_contents("http://freegeoip.net/json/" . $ipAddress), true);
    $systemInfo['city'] = $ipDetails['city'];
    $systemInfo['region'] = $ipDetails['region_name'];
    $systemInfo['country'] = $ipDetails['country_name'];
